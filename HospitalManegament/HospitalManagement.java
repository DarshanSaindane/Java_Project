...
public class HospitalManagement
{
    ...
    public static void main(String[] args)
    {
        ...
        do
        {
            ...
            System.out.println("3. Schedule Appointement");
            System.out.println("4. View Patient");
            System.out.println("5. Vieww Doctor");
            System.out.println("6. View Appointement");
...
private static void addDoctor(Scanner scanner)
{
    ...
    String name = scanner.next();
    System.out.print("Enter Doctoor's Speciality");
...
private static void scheduleAppointment(Scanner scanner)
{
    ...
    System.out.print("Enter Appointement Date (YYYY-MM-DD): ");
